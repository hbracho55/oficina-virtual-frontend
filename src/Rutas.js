...
import Correo from './componentes/formularios/Correo/Correo';
import Requerimiento from './componentes/formularios/Requerimiento/Requerimiento';
import Configuracion from './componentes/formularios/Configuracion/Configuracion';
    ...
    <div>
        <Router>      
            <Switch>
                ...
                <Route  path="/requerimientos" component={ListaPendientes} exact/>
                ...
                <Route  path="/correo" component={Correo} exact/>
                <Route  path="/requerimiento" component={Requerimiento} exact/>
                <Route  path="/configuracion" component={Configuracion} exact/>
                <Route  path="/listaadministrar" component={ListaAdministrar} exact/>
                <Route  path="/cerrarsesion" component={CerrarSesion} exact/>
            </Switch>
      </Router>
    </div>
  );
